...
var GameTitleRels = struct {
	GameGameMatches string
}{
	GameGameMatches: "GameGameMatches",
}

// gameTitleR is where relationships are stored.
type gameTitleR struct {
	GameGameMatches GameMatchSlice `boil:"GameGameMatches" json:"GameGameMatches" toml:"GameGameMatches" yaml:"GameGameMatches"`
}
...
func (r *gameTitleR) GetGameGameMatches() GameMatchSlice {
	if r == nil {
		return nil
	}
	return r.GameGameMatches
}
...
func (q gameTitleQuery) One(ctx context.Context, exec boil.ContextExecutor) (*GameTitle, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models_psql: failed to execute a one query for game_titles")
	}
...
func (q gameTitleQuery) All(ctx context.Context, exec boil.ContextExecutor) (GameTitleSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models_psql: failed to assign all query results to GameTitle slice")
	}
...
func (q gameTitleQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: failed to count game_titles rows")
	}
...
func (q gameTitleQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models_psql: failed to check if game_titles exists")
	}

	return count > 0, nil
}

// GameGameMatches retrieves all the game_match's GameMatches with an executor via game_id column.
func (o *GameTitle) GameGameMatches(mods ...qm.QueryMod) gameMatchQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"game_matches\".\"game_id\"=?", o.ID),
	)

	return GameMatches(queryMods...)
}

// LoadGameGameMatches allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (gameTitleL) LoadGameGameMatches(ctx context.Context, e boil.ContextExecutor, singular bool, maybeGameTitle interface{}, mods queries.Applicator) error {
	var slice []*GameTitle
	var object *GameTitle

	if singular {
		var ok bool
		object, ok = maybeGameTitle.(*GameTitle)
		if !ok {
			object = new(GameTitle)
			ok = queries.SetFromEmbeddedStruct(&object, &maybeGameTitle)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", object, maybeGameTitle))
			}
		}
	} else {
		s, ok := maybeGameTitle.(*[]*GameTitle)
		if ok {
			slice = *s
		} else {
			ok = queries.SetFromEmbeddedStruct(&slice, maybeGameTitle)
			if !ok {
				return errors.New(fmt.Sprintf("failed to set %T from embedded struct %T", slice, maybeGameTitle))
			}
		}
	}
	...
	query := NewQuery(
		qm.From(`game_matches`),
		qm.WhereIn(`game_matches.game_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load game_matches")
	}

	var resultSlice []*GameMatch
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice game_matches")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on game_matches")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for game_matches")
	}
	...
	if singular {
		object.R.GameGameMatches = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &gameMatchR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.GameID {
				local.R.GameGameMatches = append(local.R.GameGameMatches, foreign)
				if foreign.R == nil {
					foreign.R = &gameMatchR{}
				}
...
// AddGameGameMatches adds the given related objects to the existing relationships
// of the game_title, optionally inserting them as new records.
// Appends related to o.R.GameGameMatches.
// Sets related.R.Game appropriately.
func (o *GameTitle) AddGameGameMatches(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*GameMatch) error {
	var err error
	...
	if o.R == nil {
		o.R = &gameTitleR{
			GameGameMatches: related,
		}
	} else {
		o.R.GameGameMatches = append(o.R.GameGameMatches, related...)
	}
...
func FindGameTitle(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*GameTitle, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models_psql: unable to select from game_titles")
	}
...
func (o *GameTitle) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models_psql: no game_titles provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models_psql: unable to insert into game_titles")
	}
...
func (o *GameTitle) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models_psql: unable to update game_titles, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: unable to update game_titles row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: failed to get rows affected by update for game_titles")
	}
...
func (q gameTitleQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: unable to update all for game_titles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: unable to retrieve rows affected for game_titles")
	}
...
func (o GameTitleSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: unable to update all in gameTitle slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: unable to retrieve rows affected all in update all gameTitle")
	}
	return rowsAff, nil
}
...
func (o *GameTitle) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models_psql: no game_titles provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models_psql: unable to upsert game_titles, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models_psql: unable to upsert game_titles")
	}
...
func (o *GameTitle) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models_psql: no GameTitle provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: unable to delete from game_titles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: failed to get rows affected by delete for game_titles")
	}
...
func (q gameTitleQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models_psql: no gameTitleQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: unable to delete all from game_titles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: failed to get rows affected by deleteall for game_titles")
	}
...
func (o GameTitleSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models_psql: unable to delete all from gameTitle slice")
	}
...
func (o *GameTitleSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models_psql: unable to reload all in GameTitleSlice")
	}
...
func GameTitleExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models_psql: unable to check if game_titles exists")
	}
